...
class PgPoolTest : PgPoolTestBase {
    ...
    // @Test
    // void testReconnectQueued(TestContext ctx) {
    ...
    // @Test
    // void testAuthFailure(TestContext ctx) {
    //     Async async = ctx.async();
    ...
    // @Test
    // void testConnectionFailure(TestContext ctx) {
    //     Async async = ctx.async();
    //     ProxyServer proxy = ProxyServer.create(vertx, options.getPort(), options.getHost());
    //     AtomicReference<ProxyServer.Connection> proxyConn = new AtomicReference<>();
    //     proxy.proxyHandler(conn -> {
    ...
    // @Test
    // void testRunWithExisting(TestContext ctx) {
    //     Async async = ctx.async();
    ...
    // @Test
    // void testRunStandalone(TestContext ctx) {
    //     Async async = ctx.async();
    ...
    // @Test
    // void testMaxWaitQueueSize(TestContext ctx) {
    //     Async async = ctx.async();
    ...
    // @Test
    // void testConcurrentMultipleConnection(TestContext ctx) {
