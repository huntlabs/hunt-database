 ...
 *
 */
module hunt.database.driver.postgresql.impl.codec.DataTypeDesc;

import hunt.database.driver.postgresql.impl.codec.DataType;

import hunt.database.driver.postgresql.data.Box;
import hunt.database.driver.postgresql.data.Circle;
import hunt.database.driver.postgresql.data.Line;
import hunt.database.driver.postgresql.data.LineSegment;
import hunt.database.driver.postgresql.data.Interval;
import hunt.database.driver.postgresql.data.Path;
import hunt.database.driver.postgresql.data.Point;
import hunt.database.driver.postgresql.data.Polygon;
...
struct DataTypes {
    ...
    enum DataTypeDesc CHAR = DataTypeDesc(18, true, ["char", "string", "immutable(char)[]"]); // String.class);
    enum DataTypeDesc CHAR_ARRAY = DataTypeDesc(1002, true, null); // String[].class);
    enum DataTypeDesc VARCHAR = DataTypeDesc(1043, true, ["string", "immutable(char)[]"]); // String.class);
    ...
    enum DataTypeDesc TEXT = DataTypeDesc(25, true, ["string", "immutable(char)[]"]); // String.class);
    enum DataTypeDesc TEXT_ARRAY = DataTypeDesc(1009, true, null); // String[].class);
    enum DataTypeDesc NAME = DataTypeDesc(19, true, ["string", "immutable(char)[]"]); // String.class);
